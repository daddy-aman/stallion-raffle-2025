...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FDD698] text-slate-900 overflow-x-hidden relative selection:bg-[#FFD700] flex flex-col font-rye">
      ...
      {/* Main Content Area - Centered Flex */}
      {/* Increased bottom padding to pb-32 to ensure content clears the lights at the bottom */}
      <div className="flex-1 flex flex-col xl:flex-row items-center justify-center gap-0 md:gap-8 xl:gap-24 relative z-10 w-full max-w-[1600px] mx-auto px-4 pb-32">
        ...
        {/* Wheel Section */}
        {/* Mobile: w-full, scaled down further (0.50), translated slightly right (translate-x-1) for visual centering. Desktop: reset. */}
        {/* Changed overflow-hidden to overflow-visible to ensure pointer isn't clipped */}
